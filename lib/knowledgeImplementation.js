...
/**
 * Updates/creates a set of variants. This is used to store new variants created from VCF files. 
 ...
 * will typically complete it from the core data included above.
 * <p>
 * <ul>
 * <li>sift - e.g., { "level" : "tolerated", "score" : 0.07 }
 * <li>polyphen - e.g., { "level" : "benign", "score" : 0.002 }
 * <li>stop - e.g., "36317520"
 * <li>HGVSc - e.g., "c.3622G>T"
 * <li>cdsPosition - e.g., "3622"
 * <li>HGVSp - e.g., "p.Asp1208Tyr"
 * <li>codon - e.g., "1208"
 * <li>transcript - e.g., "ENST00000378910"
 * <li>HGVSpr - e.g., "p.D1208Y"
...
function postVariants(err, db, req, res, callback) {
  var body = req.body;

  return callback(db, err, {}, res);
}

module.exports.postVariants = postVariants;
