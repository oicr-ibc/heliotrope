 ...
 */
app.post(base + '/steps/:study', authentication.accessAuthenticator(), 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
 ...
 */
app.post(base + '/steps/:study/:role/:step', authentication.accessAuthenticator(), 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
    tracker.postStudyStep(err, db, req, res, sendPostResponse(req, res));
  })
 ...
 */
app.post(base + '/views/:study', authentication.accessAuthenticator(), 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
 ...
 */
app.post(base + '/views/:study/:role/:view', authentication.accessAuthenticator(), 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
    tracker.postStudyView(err, db, req, res, sendPostResponse(req, res));
  })
