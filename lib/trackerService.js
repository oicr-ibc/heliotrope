...
var app = module.parent.exports.app,
    ...
    authenticate = app.locals.authenticate;
 ...
 * about that study. 
 */
app.get(base + '/studies/:study', authenticate, 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
 ...
 */
app.get(base + '/studies/:study/:role/:identity', authenticate, 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
 ...
 */
app.get(base + '/studies/:study/:role/:identity/step/:step', authenticate, 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
 ...
 */
app.get(base + '/studies/:study/:role/:identity/related', authenticate, 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
 ...
 */
app.get(base + '/studies/:study/:role', authenticate, 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
 ...
 */
app.get(base + '/views/:study/:role', authenticate, 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
 ...
 */
app.post(base + '/studies/:study/:role/:identity/step/:step', authenticate, 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
 ...
 */
app.post(base + '/studies/:study/:role/:identity/step/:step/files', authenticate, 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
