...
function initializeResponse(res) {
  res.locals.serviceBase = config["trackerUriBase"];
}
...
app.get(config["trackerUriBase"] + '/studies/:study', 
...
app.get(config["trackerUriBase"] + '/studies/:study/:role/:identity',
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
...
app.get(config["trackerUriBase"] + '/studies/:study/:role/:identity/step/:step',
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
...
app.get(config["trackerUriBase"] + '/studies/:study/:role',
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
...
app.get(config["trackerUriBase"] + '/views/:study/:role', 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
...
app.post(config["trackerUriBase"] + '/studies/:study/:role/:identity/step/:step', 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
...
// Mocking 
app.post(config["trackerUriBase"] + '/studies/:study/:role/:identity/step/:step/files', 
  tracker.connected(function(err, db, req, res) {
    initializeResponse(res);
    tracker.postEntityStepFiles(err, db, req, res, sendPostResponse(req, res));
  })
);

app.get(config["trackerUriBase"] + '/*', function(req, res) {
  res.send(404);
});
