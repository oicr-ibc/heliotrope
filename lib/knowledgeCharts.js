...
var ChartMaker = require("./common/chartmaker");
...
function getVariantChartSVG(entity) {
  ...
  var positionString = entity.data.sections.positions.data[0]["codon"];
  var position = parseInt((positionString).toString());
  var mutations = isNaN(position) ? [] : [{id: entity["shortMutation"], position: position, url: null, value: 4}];
