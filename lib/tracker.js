  ...
  MongoClient.connect("mongodb://localhost:27017/tracker", function(err, db) {
    ...
    db.collection("studies", function(err, studies) {
      studies.find({name: name}).limit(1).toArray(function(err, docs) {
        ...
        var studySelector = {"studyId": new BSON.ObjectID(doc._id.toString())};
        var fields = {"_id": 1, "role": 1, "identity" : 1, "lastModified" : 1, "steps.fields.$": 1};
        
        var urlSetterFunction = urlSetter(doc);
        ...
        annotateEntity(db, doc, [countsQuery], function(o) {
...
function findStepUpdater(db, step, fields, errors, updater, callback) {    
  ...
  var remainingFields = Object.keys(fields);
