...
var aminoAcidNames = {};
for (var prop in aminoAcidCodes) {
  if(aminoAcidCodes.hasOwnProperty(prop)) {
...
var codePattern = new RegExp("[" + Object.keys(aminoAcidCodes).map(function(k) { return aminoAcidCodes[k]; }).join("") + "]", "g")
var namePattern = new RegExp("(?:" + Object.keys(aminoAcidNames).map(function(k) { return aminoAcidCodes[k]; }).join("|") + ")", "g")
...
module.exports.reverseSequence = reverseSequence;
