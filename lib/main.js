...
app.get('/tracker/api/studies/:study', function(req, res) {
  tracker.getStudy(req.params.study, sendResponse(res));
});

app.get('/tracker/api/studies/:study/:role/:identity', function(req, res) {
  tracker.getEntity(req.params.study, req.params.role, req.params.identity, sendResponse(res));
});

app.get('/tracker/api/views/:study/:role', function(req, res) {
  tracker.getViews(req.params.study, req.params.role, sendResponse(res));
});

app.get('/knowledge/api/genes/:gene', function(req, res) {
  knowledge.getGene(req.params.gene, sendResponse(res));
});

app.get('/knowledge/api/variants/:id', function(req, res) {
  knowledge.getVariant(req.params.id, sendResponse(res));
});

app.get('/knowledge/api/queries/:query', function(req, res) {
  knowledge.executeQuery(req.params.query, sendResponse(res));
});
