...
app.get('/tracker/api/studies/:study', function(req, res) {
  tracker.getStudy(req, sendGetResponse(req, res));
});

app.get('/tracker/api/studies/:study/:role/:identity', function(req, res) {
  tracker.getEntity(req, sendGetResponse(req, res));
});

app.get('/tracker/api/studies/:study/:role/:identity/step/:step', function(req, res) {
  tracker.getEntityStep(req, sendGetResponse(req, res));
});

app.get('/tracker/api/studies/:study/:role', function(req, res) {
  tracker.getEntities(req, sendGetResponse(req, res));
});

app.get('/tracker/api/views/:study/:role', function(req, res) {
  tracker.getViews(req, sendGetResponse(req, res));
});

app.get('/knowledge/api/genes/:gene', function(req, res) {
  knowledge.getGene(req, sendGetResponse(req, res));
});

app.get('/knowledge/api/variants/:id', function(req, res) {
  knowledge.getVariant(req, sendGetResponse(req, res));
});

app.get('/knowledge/api/queries/:query', function(req, res) {
  knowledge.executeQuery(req, sendGetResponse(req, res));
});

app.get('/knowledge/api/search', function(req, res) {
  knowledge.executeSearch(req, sendGetResponse(req, res));
});
...
app.post('/tracker/api/studies/:study/:role/:identity/step/:step', function(req, res) {
  tracker.postEntityStep(req, sendPostResponse(req, res));
});

// Mocking 
app.post('/tracker/api/studies/:study/:role/:identity/step/:step/files', function(req, res){
  tracker.postEntityStepFiles(req, sendPostResponse(req, res));
});
