 ...
 *
 */
function angularInit(element, bootstrap, retry) {
  ...
  if (appElement) {
    ...
    if (retry) {
      console.log('No ng-app found. Waiting and retrying...');
      setTimeout(function() { angularInit(element, bootstrap, retry - 1); }, 500);
    } else {
      console.log('Failed to find ng-app. Not retrying anymore.');
    }
  }
}
